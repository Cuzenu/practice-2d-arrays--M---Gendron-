...
// Challenge 1: Student Scores
let allScores = [
    [95, 80, 85],    // Student 1's scores
    [65, 70, 78],    // Student 2's scores
    [77, 83, 92],    // Student 3's scores
];

console.log(allScores);    // Output full array
...
console.log(theaterSeating);    // Output seating chart


//Challenge 3: Form a Multi-Dimensional Contact List
let contactList = [
    ["John Doe", "john.doe@gmail.com", "314-1234"],    // Contact 1
    ["Jane Doe", "jane.doe@gmail.com", "314-5678"],    // Contact 2
]
